      ...
      <div className="bg-white text-neutral-900 py-12 px-4 mb-8 border-b border-neutral-200">
        <div className="max-w-7xl mx-auto text-center">
          <ScrollReveal direction="down">
            <Link
              href="/shop"
              className="inline-flex items-center space-x-1 text-xs text-[#D9234B] hover:text-[#9E1B32] uppercase font-bold tracking-wider mb-4"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {categoryProducts.length === 0 ? (
          <div className="text-center py-16 bg-neutral-50 border border-neutral-200">
            ...
            <Link
              href="/shop"
              className="px-6 py-2.5 bg-[#D9234B] text-white text-xs font-bold uppercase tracking-wider hover:bg-[#9E1B32] transition-colors shadow-sm"
            >
              View Full Catalog
            </Link>
          </div>
