    ...
    <div className="bg-white min-h-screen pb-20 pt-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        <div className="flex items-center justify-between pb-4 border-b border-neutral-200">
          <div>
            <span className="text-xs uppercase font-bold tracking-[0.25em] text-[#D9234B]">Commercial RFQ</span>
            <h1 className="font-serif text-3xl font-bold text-neutral-900 mt-1">Quotation Requests (RFQ)</h1>
          </div>
            ...
            <tbody>
              {MOCK_QUOTATIONS.map((q) => (
                <tr key={q.id} className="border-b border-neutral-200 hover:bg-neutral-50">
                  ...
                  <td className="p-3 text-neutral-600">₹{q.gstAmount.toLocaleString('en-IN')}</td>
                  ...
                  <td className="p-3 text-neutral-500">{q.validUntil}</td>
                </tr>
              ))}
            </tbody>
          </table>
