    ...
    <div className="bg-white min-h-screen pb-20 pt-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        <div className="flex items-center justify-between pb-4 border-b border-neutral-200">
          <div>
            <span className="text-xs uppercase font-bold tracking-[0.25em] text-[#D9234B]">Tax Invoice Preview</span>
            <h1 className="font-serif text-3xl font-bold text-neutral-900 mt-1">GST Tax Invoice #INV-2026-089</h1>
          </div>
          <div className="flex space-x-2">
            ...
            <Link href="/wholesale/dashboard" className="px-4 py-2 border border-neutral-300 text-xs font-bold text-neutral-700 hover:bg-neutral-100">
              Back
            </Link>
          </div>
        </div>
        ...
        <div className="bg-white border-2 border-neutral-900 p-8 space-y-6 shadow-xl print:shadow-none print:border-none">
          <div className="flex justify-between items-start pb-6 border-b border-neutral-300">
            <MudraLogo size="sm" />
            <div className="text-right text-xs text-neutral-600">
              <h2 className="font-serif font-bold text-base text-neutral-900 uppercase">ORIGINAL TAX INVOICE</h2>
          ...
          <div className="grid grid-cols-2 gap-6 text-xs border-b border-neutral-300 pb-6">
            <div>
              <span className="font-bold text-neutral-900 uppercase block mb-1">Billed To (Customer):</span>
              <p className="font-bold text-neutral-800">Apex Corporate Garments Ltd</p>
              <p className="text-neutral-600">GSTIN: 29ABCDE1234F1Z5</p>
              <p className="text-neutral-600">Apex Towers, Tech Park Phase 2, Whitefield</p>
              <p className="text-neutral-600">Bengaluru, KA 560066</p>
            </div>
            <div className="text-right">
              <span className="font-bold text-neutral-900 uppercase block mb-1">Supplier Details:</span>
              <p className="font-bold text-neutral-800">MUDRA FASHIONS TEXTILES PVT LTD</p>
              <p className="text-neutral-600">Commercial Complex, Indiranagar</p>
              <p className="text-neutral-600">Bengaluru, KA 560038</p>
              <p className="text-neutral-600">Email: billing@mudrafashions.com</p>
            </div>
          </div>
          ...
          <div className="flex justify-end pt-4">
            <div className="w-64 space-y-1.5 text-xs text-neutral-700">
              ...
              <div className="flex justify-between font-bold text-sm text-neutral-900 pt-2 border-t border-neutral-300">
                ...
                <span className="text-[#D9234B]">₹1,26,000</span>
              </div>
            </div>
          </div>
        </div>
